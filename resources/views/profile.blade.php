                    ...
                    <div class="col-xl-5 col-md-6 col-sm-12">
                        <div class="card" >
                            <div class="card-content">
                                <img  style="height: 450px" src="{{ URL::to('public/upload/' . ($sinhvien->anhdaidien ?? 'default-avatar.png')) }}"
                    ...
                    <div class="col-xl-7 col-md-6 col-sm-12">
                       ...
                       <div class="card">
                        ...
                        <form action="{{ route('accountStudent.update', $sinhvien->id) }}"
                            class="form-horizontal" style="padding: 20px; height: 620px" method="post">
                            @csrf
                            @method('PUT')
