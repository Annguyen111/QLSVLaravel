                    ...
                    <div class="card">
                        ...
                        @include('notification')
                            <div class="card-body">
                                ...
                                <form class="form" method="post" action="{{ route('sinhvien.update',$sinhvien->id) }}" enctype="multipart/form-data">
                                  @csrf
                                  @method('PUT')
                                    <div class="row">
                                      ...
                                      <div class="col-md-6 col-12">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="email" id="country-floating" name="email" class="form-control"
                                                     placeholder="Email" value="{{ $sinhvien->email }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                          <div class="form-group">
